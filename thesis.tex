...
\abstract{Software engineering requires rigorous testing to guarantee the
  ...
  by nondeterminism in systems' behavior, which makes testers difficult to write
  and reason about.

  This thesis presents a language-based technique for testing interactive
  systems.  I propose a theory for specifying and validating systems'
  ...
  producing test inputs that can effectively detect and reproduce systems'
  invalid behaviors.
...
\lstset{escapechar=\%,style=customcoq,belowskip=0em}
