...
language for specifying protocols.  \autoref{sec:internal-nondet} and
\autoref{sec:external-nondet} address internal and external nondeterminism in
ITrees.  \autoref{sec:spec-to-test} explains the derivation mechanism from ITree
specifications to interactive tester programs, using \http as an example.
...
The derivation framework is shown in outline in \autoref{fig:framework}.  Each
