...
events.  The usage of the \ilc{Tau} constructor will be further explained in
...
Other events \ilc{\{E\}} made by the server model {\it e.g.} internal choices
(\ilc{choiceE}) in \autoref{sec:itree-lang}.
