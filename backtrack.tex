...
\item When the tester wants to observe a packet {\em from} itself, it generates
  ...
  matching the branches against the send event, using the \ilc{expect} function.
...
continuously sending request packets.  \lys{This part is not critical.  I can
imagine other scheduler design to do the same job.}
